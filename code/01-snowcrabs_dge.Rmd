...
mkdir ../output/kallisto_01_paired

#find specific files and create abundance estimates
find /home/shared/8TB_HDD_01/snow_crab/5010/exp01/*fastq.gz \
| xargs basename -s _R?_001.fastq.gz | xargs -I{} \
/home/shared/kallisto/kallisto \
quant -i ../data/cbai_genome_v1.0.index \
-o ../output/kallisto_01_paired/{} \
-t 40 \
#run next two lines to use forward and reverse in abundance index
/home/shared/8TB_HDD_01/snow_crab/5010/exp01/{}_R1_001.fastq.gz #forward
/home/shared/8TB_HDD_01/snow_crab/5010/exp01/{}_R2_001.fastq.gz #reverse
```
